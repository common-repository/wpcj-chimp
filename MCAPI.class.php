...
class MCAPI {
    ...
    */
     ...
     * @param boolean $send_welcome - if you double_optin is false and this is true, we will send your lists Welcome Email if this subscribe succeeds - will *not* fire if we end up updating an existing subscriber. defaults to false
